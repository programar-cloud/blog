---
title: "Escalando a un millón de usuarios"
date: 2017-07-29
...
disqus_title: Escalando a un millón de usuarios
---
...
Por cierto, la máquina que utilizaban como servidor era menos potente que un Macbook pro de 2010.

Te puedes imaginar la primera semana de vida del proyecto: las ojeras de Kevin y Mike llegaron a hacerse permanentes mientras peleaban por mantener viva la crituara. Kevin comentó en alguna ocasión que "escalar Instagram fue el equivalente a cambiar todas las piezas de un coche... mientras conduces a 180km/h.".
...
Espero que recuerdes la sexta regla de escalado: la mejor manera de aumentar el throughput de una base de datos relacional es no utilizarla (por ejemplo, porque consultas previamente una caché).
...
Facebook no tiene problemas de liquidez, al contrario. A mi me gusta imaginarme a Mark nadando entre monedas de oro como tío Gilito. Y el core de su negocio es muy tecnológico: es cierto que el software es un medio para vender publicidad pero es **el medio**. Por ello no escatiman ni intentan ser especialmente eficientes en el uso de IT.
