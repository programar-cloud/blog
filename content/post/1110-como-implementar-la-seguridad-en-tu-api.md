...
date: 2017-06-02T12:38:20+01:00
...
*TL;DR: Basic auth solo sirve para conseguir un token, que puede ser un API Key o un JWT. OAuth2 sirve para delegar, no para autenticar. Y todo tiene que ir por TLS. ¡Ah! Y nada de cookies. Ok, ahora me explico con más detalle.*
...
Esta llave puede intercambiarse en el momento en el que el humano responsable de la aplicación cliente que quiere acceder a tu API la registra en tu sistema. Es lo que por ejemplo haces al utilizar los espectaculares [cognitive services](https://www.microsoft.com/cognitive-services/en-us/apis) de Azure para añadir inteligencia artificial a tus programa: primero accedes al servicio de Microsoft a través de una web que te permite dar de alta tu aplicación y te proporciona dos *API keys*. El tener disponibles simultáneamente dos te permite rotarlas con mayor facilidad creando la segunda sin desactivar la primera durante un tiempo.
...
Gracias al sistema de cache también mejoras el rendimiento de tu sistema y puedes encima **te permite *productivizar* tu API**: un usuario gratuito (anónimo) podría por ejemplo invocarla una vez por minuto mientras que un usuario *premium* tendría una cuota más alta. Y el API gateway se encargaría de que se cumpliesen esas normas.
...
No te quejarás por falta de turrón en el post de hoy ¿eh? Pero estoy llegando a las 5000 palabras que es demasiado incluso para mi así que voy cortando ya. A estas alturas deberías tener claro lo siguiente:
...
pppd: Aquí te dejo un imprescindible site en el que se ofrecen todo tipo de [detalles sobre las cookies](http://www.recetacookies.com/).

ppppd: El diagrama de Trump in the Middle se basa en el [artículo sobre MitM](https://es.wikipedia.org/wiki/Ataque_de_intermediario) de la Wiki con un toque de [Nei Ruffino ](http://toolkitten.deviantart.com/art/PoliticsGQ-594831165). En serio, échale un ojo a sus ilustraciones.

pppppd: Y last but not least ¡mil gracias otra vez a [Humbert](https://twitter.com/ackhum) por sus aportaciones al post! Si no le conocéis estad pendientes de su tuiter porque es una de las personas que más sabe sobre seguridad informática que podéis encontrar.
